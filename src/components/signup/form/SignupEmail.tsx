...
export default function SignupEmail({setEmail,setBlockButton,setCheckError,setShowInput,setTimer,setEmailCheckShow,email,timer,blockButton }:SignupEmailProps) {
     const onEmailChangeHandler = (e: React.ChangeEvent<HTMLInputElement>) => {
       e.preventDefault();
       setEmail(e.currentTarget.value);
     };

     const onEmailSendHandler = async (

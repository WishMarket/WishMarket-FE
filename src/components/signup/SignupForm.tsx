        ...
        <div className="signup_Wrapper main">
            <div className="signup">
                ...
                <div className="signup_content">
                    <form onSubmit={onLoginSubmitHandler} target="blankifr" className="signup-form-container">
                        <div className="signup_Form">
                            <div className="sign-up-form-container">
                                <input id="email" type="email" placeholder="이메일" className="signup_Input_Box email-check" onChange={onEmailChangeHandler} required readOnly={!blockButton} />
                                <AiOutlineMail className="Login_Icon" />
                                <button className="sign-up-check-btn" type="button" onClick={onEmailCheckHandler} disabled={!blockButton}>
                                    중복 확인
                                </button>
                            </div>
                            <div className="sign-up-form-container">
                                <input id="password" type="password" placeholder="비밀번호" className="signup_Input_Box" onChange={onPasswordChangeHandler} autoComplete="off" required />
                                <RiLockPasswordLine className="PW_Icon" />
                            </div>
                            <div className="sign-up-form-container">
                                <input id="re-password" type="password" placeholder="비밀번호 확인" className="signup_Input_Box" onChange={onRetypePasswordChangeHandler} autoComplete="off" required />
                                <RiLockPasswordLine className="PW_Icon" />
                            </div>
                            <div className="sign-up-form-container">
                                <input id="name" type="text" placeholder="이름" className="signup_Input_Box" onChange={onNameChangeHandler} required />
                                <SlPeople className="name-icon" />
                            </div>
                            <div className="sign-up-form-container">
                                <input id="nickname" type="text" placeholder="닉네임" className="signup_Input_Box" onChange={onNicknameChangeHandler} required />
                                <SlPeople className="name-icon" />
                            </div>
                        </div>
                    </form>
                    <div className="signup_Button">
                        <button className="btn btn-warning" type="submit" disabled={blockButton}>
                            회원가입
                        </button>
                    </div>
                </div>

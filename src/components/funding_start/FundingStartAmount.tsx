...
export default function FundingStartAmount({ setFundingAmount, price }: FundingStartAmountProps) {
    ...
    return (
        <div className="FundingStart_Desc_Bottom">
            ...
            <div className="Funding_Amount_Flex">
                <input id="Funding_Amount" type="number" onChange={onChangeAmount} step="10" min="0" max={price} />

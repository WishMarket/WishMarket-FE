                      ...
                      <ul className="FriendPicker_Wrapper">
                        ...
                        {!lastPage ? (
                          <div className="See_more">
                            <button
                              className="btn btn-warning See_more_Button"
                              onClick={FriendCallHandler}
                              type="button"
                            >
                              친구 더 보기
                            </button>
                          ...
                          <Link
                            to="/searchfriends"
                            className="Last_Friend_Wrapper"
                          >
                            <div className="Last_Friend">
                              <h2 className="Last_Friend_title">
                                마지막 친구 입니다.
                              </h2>
                              <p className="Last_Friend_Detail">
                                친구찾기에서 더많은 친구를 찾아보세요
                              </p>
                            </div>
                          </Link>
                        )}

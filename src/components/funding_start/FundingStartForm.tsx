...
export default function FundingStartForm() {
    ...
    const onFriendsSelectHandler = (Userid: string, name: string, profile: string) => {
                    ...
                    {items != null ? (
                        <form onSubmit={onSubmitHandler} target="blankifr">
                            <div className="FundingStart_Top_Area">
                                <div>
                                    <img src={items.image} alt={items.name} className="FundingStart_Img" />
                                </div>
                                            ...
                                            <ul className="FriendPicker_Wrapper">
                                                {friends.map((data: FriendsObj) => (
                                                    <FriendPicker
                                                        ...
                                                        email={data.email}
                                                        FriendSelect={(Userid, name, profile) => onFriendsSelectHandler(Userid, name, profile)}
                                                    />
                                                ))}
                                            </ul>
                                        </div>

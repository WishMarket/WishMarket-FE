...
export default function FamousFriendCard({ userId, name, nickname, famous, profileImageUrl, isFriend }: FamousFriendObj) {
    ...
    if (userId == null) {
        ...
        return (
            <div className="FriendResult_Wrapper">
                <div>
                    <img src={profileImageUrl ? profileImageUrl : defaultImg} className="FriendResult_image" />
                </div>

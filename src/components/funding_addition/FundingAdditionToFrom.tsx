...
export default function FundingAdditionToFrom({ targetUserName, targetUserProfileImageUrl, participantsNameList, participationCount }: FundingAdditionToFromProps) {
        ...
        <div>
            <div className="FundingAddition_To">
                ...
                <div className="To_desc">
                    <img src={targetUserProfileImageUrl ? targetUserProfileImageUrl : defaultImg} className="To_image"></img>
            ...
            <div>
                <span className="FundingAddition_From">
                    ...
                    <div className="From_desc">
                        <span>{participantsNameList ? FormatParticipant() : "참여한 친구가 없습니다."}</span>
                    </div>
                </span>
            </div>
        </div>

                        ...
                        <>
                            <form onSubmit={onSubmitHandler} target="blankifr">
                                <div className="FundingAddition_Top_Area">
                                    <div>
                                        <img src={items.productImageUrl} alt={items.productName} className="FundingAddition_Img" />
                                    </div>
                                    <div className="FundingAddition_Desc">
                                        <div className="FundingAddition_Title">{items.productName}</div>
                                        ...
                                        <FundingAdditionGraph targetPrice={items.targetPrice} myFundedPrice={items.myFundedPrice} totalFundedPrice={items.totalFundedPrice} />
                                        ...
                                        <FundingAdditionToFrom
                                            ...
                                            targetUserProfileImageUrl={items.targetUserProfileImageUrl}
                                            participantsNameList={items.participantsNameList}
                                            participationCount={items.participationCount}
                                        />
                                        <FundingAdditionAmount setFundingAmount={setFundingAmount} targetPrice={items.targetPrice} totalFundedPrice={items.totalFundedPrice} />
                                    </div>
                                </div>
                            </form>
                        </>

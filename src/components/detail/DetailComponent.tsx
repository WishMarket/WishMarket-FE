                ...
                <div className="Detail_Desc">
                  <div className="Detail_Desc_Top">
                    <div className="Detail_Like_Area">
                      ...
                      {items.best ? (
                        <div className="Detail_Best_Badge">BEST</div>
                      ) : null}
                    </div>
                    ...
                    <div className="Modal_Inner">
                      ...
                      <button className="btn btn-light">
                        <IoMdCopy
                          ...
                          onClick={() => CopyClipBoard(items.url)}
                        />
                      </button>
                    </div>
                  </Modal.Body>
                ...
                <div className="Detail_Info_Wrapper">
                  <ul className="Detail_Info_Inner">
                    {tabs.map((tab) => (
                      <li
                        id="Detail_Info_Tab"
                        className={tab.id === currentTab ? "focused" : ""}
                        onClick={() => selectMenuHandler(tab.id)}
                        key={tab.id}
                      >
                        {tab.name}
                      </li>

    ...
    return (
        <div className="Famous_Funding_Item">
            ...
            <div className="Famous_Funding_Card_Inner">
                <img src={gift.product.productImageUrl} alt={gift.product.name} className="Famous_Funding_Img" />
                <div className="Famous_Funding_Content">
                    <div className="Famous_Funding_Info">
                        ...
                        <div className="Famous_Funding_Top_Area">
                            <div className="Famous_Funding_Item_Title">{gift.product.name}</div>
                            <div className="Famous_Funding_Price">{commaNums(gift.product.price)} 원</div>
                        </div>
                        <div
                        ...
                        >
                            <div
                                ...
                                style={{
                                    width: `${((gift.fundedPrice / gift.product.price) * 100).toFixed(2)}%`,
                                }}
                            >
                        ...
                        <div className="Famous_Funding_Gathered">
                            ...
                            <div className="Famous_Funding_Gathered_Content">{commaNums(gift.fundedPrice)} 원</div>
                        </div>
                        <div className="Famous_Funding_Remaining">
                            <div className="Famous_Funding_Remaining_Label">남은 금액</div>
                            <div className="Famous_Funding_Remaining_Content">{commaNums(gift.product.price - gift.fundedPrice)} 원</div>
                        </div>
                        <div className="Famous_Funding_Attend">
                            <div className="Famous_Funding_Attend_Label">참여자 목록</div>
                            <div className="Famous_Funding_Attend_Content">{gift.participants.join(", ")}</div>
                            <div className="Famous_Funding_Attend_Badge">{gift.participants.length} 명 참여</div>
                        </div>
                        <div className="Famous_Funding_Payment">
                            <div className="Famous_Funding_Payment_Label">내 펀딩 금액</div>
                            <div className="Famous_Funding_Payment_Content">{commaNums(gift.myfundingPrice)} 원</div>
                        </div>
                    </div>

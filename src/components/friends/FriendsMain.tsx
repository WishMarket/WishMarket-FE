    ...
    return (
        <div className="FriendMain_Wrapper">
            <div className="FriendMain_DESC">
                <div className="FriendMain_Title">친구의 이름이나 이메일을 검색해 보세요.</div>
                <div className="FriendSearch_Wrapper">
                    <form onSubmit={onSubmitHandler}>
                        <div className="FriendMain_Search">
                            ...
                            <input type="text" placeholder="친구를 검색해 보세요." onChange={onInputChangeHandler} />
                ...
                {input != "" ? <SearchForm input={input} select={select} selected={selected} /> : null}
